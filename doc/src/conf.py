# -*- coding: utf-8 -*-
#
# orion.algo.grid_search documentation build configuration file.
#
...
import orion.algo.grid_search as algo_plugin
...
project = u'orion.algo.grid_search'
...
htmlhelp_basename = 'grid_searchdoc'
...
latex_documents = [
  (master_doc, 'orion.algo.grid_search.tex',
   u'Oríon algo grid_search Documentation',
...
texinfo_documents = [
  (master_doc, 'grid_search',
   u'Oríon algo grid_search Documentation',
   author, 'grid_search', algo_plugin.__descr__,
   'Miscellaneous'),
]
