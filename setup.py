#!/usr/bin/env python
# -*- coding: utf-8 -*-
"""Installation script for `orion.algo.grid_search`."""
import os
...
setup_args = dict(
    ...
    url='https://github.com/bouthilx/orion.algo.grid_search',
    packages=['orion.algo.grid_search'],
    package_dir={'': 'src'},
    include_package_data=True,
    entry_points={
        'OptimizationAlgorithm': [
            'grid_search_GridSearch = orion.algo.grid_search.gridsearch:GridSearch'
            ],
        },
